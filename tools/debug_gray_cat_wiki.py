...
def main() -> int:
    out_dir = r"c:\Users\leona\Downloads\videogenerator\output\debug_gray_cat"
    os.makedirs(out_dir, exist_ok=True)

    found = _buscar_wikimedia_imagenes("gray cat portrait photo", max_results=5)
    ...
    url, title = found[0]
    dst = os.path.join(out_dir, "gray_cat_01.jpg")
